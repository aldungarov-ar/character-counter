...
public class LoggingAspect {
    @Around("ru.t1consulting.charctercounter.aspect.LoggingPointcuts.springBeanPointcut() && " +
            "ru.t1consulting.charctercounter.aspect.LoggingPointcuts.applicationPackagePointcut() && " +
            "ru.t1consulting.charctercounter.aspect.AnnotationPointcuts.info()")
    ...
    @Around("ru.t1consulting.charctercounter.aspect.LoggingPointcuts.springBeanPointcut() && " +
            "ru.t1consulting.charctercounter.aspect.LoggingPointcuts.applicationPackagePointcut() && " +
            "ru.t1consulting.charctercounter.aspect.AnnotationPointcuts.debug()")
    ...
    @AfterThrowing(
            pointcut =
                    "ru.t1consulting.charctercounter.aspect.LoggingPointcuts.springBeanPointcut() && " +
                            "ru.t1consulting.charctercounter.aspect.LoggingPointcuts.applicationPackagePointcut()",
            throwing = "ex")
